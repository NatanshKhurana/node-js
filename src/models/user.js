...
const userSchema = new mongoose.Schema(
  {
    firstName: {
      ...
      minLength: [
        3,
        `firstName must include atleast 3 characters, got {VALUE}`,
      ],
      maxLength: [
        100,
        `firstName must include atmost 100 characters, got {VALUE}`,
      ],
      trim: true,
    },
    lastName: {
    ...
    photoUrl: {
      type: String,
      default:
        "https://i.pinimg.com/564x/df/3d/33/df3d337449a55926b196debf6e138e5a.jpg",
      trim: true,
    },
    skills: {
      type: [String],
